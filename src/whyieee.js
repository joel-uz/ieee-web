import world from "./assets/global.png"
        ...
        <div className="page-lay">
            ...
            <div className="cards">
                ...
                <div className="left">
                    ...
                    <p className="text">
                    IEEE plays a crucial role in setting global standards for various technological domains. It develops 
                ...
                <div className="center">
                    ...
                    <p className="text">
                    IEEE provides a vast platform for knowledge sharing and networking among professionals, researchers, 
                ...
                <div className="right">
                    ...
                    <p className="text">
                    IEEE offers a range of educational resources and professional development opportunities to support the 
